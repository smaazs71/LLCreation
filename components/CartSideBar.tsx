...
const CartSideBar = ({ cartSideBar, setCartSideBar }: CartSideBarProps) => {
  ...
  return (
    ...
    >
      <aside
        className="fixed inset-0 z-50 h-full overflow-hidden r-0"
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            style={{ opacity: 1 }}
          ></div>
          <div className="absolute inset-y-0 flex max-w-full outline-none bg-white right-0 rtl:right-0">
            <div className="h-full w-screen max-w-md">
              <div className="drawer flex h-full flex-col bg-white text-base shadow-xl">
                ...
                >
                  ...
                  <div
                    className="os-viewport os-viewport-scrollbar-hidden m-0 t-0 r-auto l-0 w-full p-0"
                    style={{ overflowY: "scroll" }}
                  ></div>

                  <section className="relative flex h-full flex-col">
                    <header className="fixed top-0 z-10 flex w-full max-w-md items-center justify-between border-b border-border-200 border-opacity-75 bg-white px-6 py-4">
                    ...
                    <div
                      className="grow pt-16 pb-20 os-viewport os-viewport-scrollbar-hidden"
                        ...
                        >
                          <div className="flex-shrink-0">
                            <div className="flex overflow-hidden flex-col-reverse items-center w-8 h-24 bg-gray-100 text-heading rounded-full">
                              <button
                                onClick={() => {
                                  updateProductQuantityFromCart(product.id, -1);
                                }}
